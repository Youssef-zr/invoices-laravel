...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"><a href="{{ adminUrl('roles') }}">الصلاحيات</a></h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ اضافة صلاحية</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-2">
                                    <div class="form-group {{$errors->has('name') ? 'has-error' : ''}}">
                                        ...
                                        {!! Form::text('name', old('name'), ['class'=>'form-control',"placeholder"=>"اسم الصلاحية"]) !!}
                                            ...
                                            <li class="branch"> <a href="#">الصلاحيات</a>
                                                ...
                                                <ul class="mt-3">
                                                    ...
                                                    <li class="permissions">
                                                        {!! Form::checkbox("permission[]", $perm->name, old('permission'), ["class"=>'form-checkbox d-none']) !!}
